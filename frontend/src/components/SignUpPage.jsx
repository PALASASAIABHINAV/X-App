...
const SignUpPage = () => {
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
      ...
      <div className="w-full h- max-w-6xl flex flex-col lg:flex-row items-center justify-center p-4 relative z-10">
        {/* Left logo section */}
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center gap-6">
              ...
              <div className="w-full space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <label className="group flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <MdDriveFileRenameOutline className="text-blue-400" />
                      <span className="text-gray-300 text-sm">Full Name</span>
                    </div>
                    <input
                      type="text"
                      name="fullName"
